...
const DATA: KosherSection[] = [
  ...
  },
  {
    ...
    tips: ["שישי בערב חובה להזמין - 300-400 באט לאדם", "יש משלוחים למלון Amari (10 דק׳ נסיעה)", "מכולת כשרה עם לחם, גבינות, נקניקים"],
  },
  {
    city: "בנגקוק",
    emoji: "🏙️",
    ...
    tips: ["הכי נוח - המלון שלכם על קאו סאן, חב״ד 5 דק׳ הליכה!", "יש גם סופר כשר קטן עם מוצרים מיובאים", "שבת בבנגקוק: חוויה גדולה, כ-500 באט"],
  },
  {
    city: "קנצ׳נבורי",
    emoji: "🌉",
